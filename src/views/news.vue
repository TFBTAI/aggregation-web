...
<script>
  export default {
    ...
    methods:{
      async getNodeList() {
         let resultList = await this.$axios.get(`initPage/?category=news`)
            .then(
      ...
      async getNodesSize() {
        let nodeSize = await this.$axios.get(`getNodesSize/?category=news`)
            .then(
                async function(response){
                  return await response.data;
                }
      ...
      async getMoreNodes() {
        if(this.nodeList.length < this.nodeSize){
          let resultList = await this.$axios.get(`getMoreNodes/?category=news`)
              .then(
                  async function(response){
                    return await response.data;
                  }
